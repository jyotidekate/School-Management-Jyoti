...
<body class="skin-blue sidebar-mini"
   ...
   <!-- <form method="post" action="saveInvestment" id="form1"  modelAttribute="user"> -->
      <div
                                 ...
                                 <div class="col-sm-8">
                                    <select name="searchMemberCode"
                                       ...
                                       <option value="01/NGP/ 000098">PRAMILA
                                          GOURISHANKAR PAWAR - 01/NGP/ 000098
                                       </option>
                                       <option value="01/NGP/ 000099">PRANIL KRISHNARAO
                                          MENDHE - 01/NGP/ 000099
                                       </option>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <select name="nomineeRelation"
                                       id="nomineeRelation" class="form-control"
                                       style="width: 100%;">
      ...
      <script src="dist/js/addInvestment.js"></script>
      <!-- Select2 -->
      ...
      <script type="text/javascript">
         ...
         ContentPlaceHolder1_RequiredFieldValidator5.controltovalidate = "ContentPlaceHolder1_txtPolicyDate";
         ContentPlaceHolder1_RequiredFieldValidator5.focusOnError = "t";
         ContentPlaceHolder1_RequiredFieldValidator5.errormessage = "Enter Policy Date";
         ...
         ContentPlaceHolder1_RequiredFieldValidator1.controltovalidate = "ContentPlaceHolder1_txtPin";
         ContentPlaceHolder1_RequiredFieldValidator1.focusOnError = "t";
         ContentPlaceHolder1_RequiredFieldValidator1.errormessage = "Enter PIN";
         ...
         ContentPlaceHolder1_RequiredFieldValidator2.controltovalidate = "ContentPlaceHolder1_txtMDate";
         ContentPlaceHolder1_RequiredFieldValidator2.focusOnError = "t";
         ContentPlaceHolder1_RequiredFieldValidator2.errormessage = "Enter Maturity Date";
         ...
         ContentPlaceHolder1_RequiredFieldValidatorPolicyAmount.errormessage = "Enter Policy Amount";
