...
<aside class="main-sidebar">
	...
	<section class="sidebar" style="height: auto;">
		...
		<ul class="sidebar-menu tree" data-widget="tree">
			...
			<li class="treeview">
				<%if(serviceList!=null && serviceList.contains("Add Member")||serviceList.contains("Add Member KYC")||serviceList.contains("Member Summary")||serviceList.contains("Member Report")||serviceList.contains("Search Member")
